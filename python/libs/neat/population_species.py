...
class PopulationSpecies:
    ...
    def set_allowed_offspring(self):
        ...
        for sp in self.species:
            ...
            sp.allow_offspring = int(proportion * self.pop_size)
    ...
    def adjust_compatibility_threshold(self):
        ...
        if abs(species_diff) > 1:
            adjustment = 0.05 * species_diff
            self.compatibility_threshold += adjustment
        
        self.compatibility_threshold = max(0.5, min(self.compatibility_threshold, 10.0))
    ...
    def reset(self):
        ...
        new_pop: list[Genome] = [self.best_local.clone()]
    ...
    def run(self, fitness_function: Callable[[list[Genome]], None], n: int = 0):
        ...
        while self.generation < n or n == 0:
            ...
            print(f"Staleness: {[sp.staleness for sp in self.species]}")
