...
# from game_types import Entity, Graphic, Vec2
# from utils import tuple_2_vec2, gradient_color
...
#         Entity.__init__(self, Vec2(x, y), image.get_rect().w, image.get_rect().h, 0)
...
#         x, y = pos
#         self.ps.add_particle(ParticleExhaust(self, x, y, 3, 0.1, self.exhaustRange, 4, 30))
